...
class TestSuiteBasics():
  ...
  def test_loginBasico(self):
    self.driver.get("<<PROTOCOLO>>://<<HOST>>/sip/login.php?sigla_orgao_sistema=ORGAO1&sigla_sistema=SEI&infra_url=L3NlaS8=")
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.XPATH, "//a[contains(.,\'99990\')]")))
