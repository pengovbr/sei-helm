...
Common labels
*/}}
{{- define "sei-db.labels" -}}
helm.sh/chart: {{ include "sei-db.chart" . }}
{{ include "sei-db.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "sei-db.selectorLabels" -}}
app.kubernetes.io/name: {{ include "sei-db.name" . }}
