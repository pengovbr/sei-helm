...
echo "***************************************************"
echo "***************************************************"
echo "*INICIANDO CONFIGURACOES DO MODULO ASSINATURA####**"
echo "***************************************************"
echo "***************************************************"
...
{{- if .Values.app.modulo_assinatura_instalar }}
    ...
    if [ -f /var/lib/sei/dbcontrol/modulo-assinatura-instalado-${VERSAO_ENCONTRADA}.ok ]; then
        ...
        cd /opt
        echo -ne "$APP_DB_ROOT_USERNAME\n$APP_DB_ROOT_PASSWORD\n" | \
            php sip/scripts/mod-assinatura-eletronica/sip_atualizar_versao_modulo_assinatura.php 2>&1 | \
            tee -a /var/lib/sei/dbcontrol/atualizacao-modulo-assinatura-${VERSAO_ENCONTRADA}.output
        ...
        echo -ne "$APP_DB_ROOT_USERNAME\n$APP_DB_ROOT_PASSWORD\n" | \
            php sei/scripts/mod-assinatura-eletronica/sei_atualizar_versao_modulo_assinatura.php 2>&1 | \
            tee -a /var/lib/sei/dbcontrol/atualizacao-modulo-assinatura-${VERSAO_ENCONTRADA}.output
        ...
        touch /var/lib/sei/dbcontrol/modulo-assinatura-instalado-${VERSAO_ENCONTRADA}.ok
